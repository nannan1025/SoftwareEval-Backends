...
#ifndef SWEVAL_BACKENDS_CV32E40P_CORE_PERFORMANCE_MODEL_H
#define SWEVAL_BACKENDS_CV32E40P_CORE_PERFORMANCE_MODEL_H
...
extern SchedulingFunctionSet* CV32E40P_CORE_SchedulingFunctionSet;

class CV32E40P_CORE_PerformanceModel : public PerformanceModel
{
public:

  CV32E40P_CORE_PerformanceModel() : PerformanceModel("CV32E40P_CORE", CV32E40P_CORE_SchedulingFunctionSet)
    ,regModel(this)
...
#endif // SWEVAL_BACKENDS_CV32E40P_CORE_PERFORMANCE_MODEL_H