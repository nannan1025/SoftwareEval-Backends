...
#ifndef SWEVAL_BACKENDS_CV32E40P_CORE_PRINTER_H
#define SWEVAL_BACKENDS_CV32E40P_CORE_PRINTER_H
...
class CV32E40P_CORE_Printer : public Printer
{
public:

  CV32E40P_CORE_Printer();
...
#endif // SWEVAL_BACKENDS_CV32E40P_CORE_PRINTER_H