...
extern InstructionPrinterSet* CV32E40P_CORE_InstrPrinterSet;

CV32E40P_CORE_Printer::CV32E40P_CORE_Printer(): Printer("CV32E40P_CORE_Printer", CV32E40P_CORE_InstrPrinterSet)
{}

void CV32E40P_CORE_Printer::connectChannel(Channel* ch_)
{
  CV32E40P_CORE_Channel* channel = static_cast<CV32E40P_CORE_Channel*>(ch_);
...
std::string CV32E40P_CORE_Printer::getPrintHeader(void)
{
