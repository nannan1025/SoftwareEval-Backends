...
extern InstructionPrinterSet* CVA6_QWEN_1_InstrPrinterSet;

CVA6_QWEN_1_Printer::CVA6_QWEN_1_Printer(): Printer("CVA6_QWEN_1_Printer", CVA6_QWEN_1_InstrPrinterSet)
{}

void CVA6_QWEN_1_Printer::connectChannel(Channel* ch_)
{
  CVA6_QWEN_1_Channel* channel = static_cast<CVA6_QWEN_1_Channel*>(ch_);
...
std::string CVA6_QWEN_1_Printer::getPrintHeader(void)
{
