...
InstructionPrinterSet *CVA6_QWEN_1_InstrPrinterSet = new InstructionPrinterSet("CVA6_QWEN_1_InstrPrinterSet");

static InstructionPrinter *instrPrinter__def = new InstructionPrinter(
  CVA6_QWEN_1_InstrPrinterSet,
  "_def",
  0,
  [](Printer* printer_){
    std::stringstream ret_strs;
    CVA6_QWEN_1_Printer* printer = static_cast<CVA6_QWEN_1_Printer*>(printer_);
