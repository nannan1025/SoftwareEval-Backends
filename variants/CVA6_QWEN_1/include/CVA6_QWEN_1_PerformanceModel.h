...
#ifndef SWEVAL_BACKENDS_CVA6_QWEN_1_PERFORMANCE_MODEL_H
#define SWEVAL_BACKENDS_CVA6_QWEN_1_PERFORMANCE_MODEL_H
...
extern SchedulingFunctionSet* CVA6_QWEN_1_SchedulingFunctionSet;

class CVA6_QWEN_1_PerformanceModel : public PerformanceModel
{
public:

  CVA6_QWEN_1_PerformanceModel() : PerformanceModel("CVA6_QWEN_1", CVA6_QWEN_1_SchedulingFunctionSet)
    ,IF_stage(3,0)
    ,IQ_stage(7,0)
    ,EX_stage(8,0)
    ,COM_stage(2,0)
  ...
  uint64_t ID_stage = 0;
  uint64_t Issue_stage = 0;
  uint64_t EX_ALU_substage = 0;
  uint64_t EX_MUL_substage_0 = 0;
  uint64_t EX_MUL_substage_1 = 0;
  uint64_t EX_DIV_substage = 0;
  ...
  uint64_t EX_CSR_substage = 0;
  uint64_t EX_FPU_substage = 0;
...
#endif // SWEVAL_BACKENDS_CVA6_QWEN_1_PERFORMANCE_MODEL_H