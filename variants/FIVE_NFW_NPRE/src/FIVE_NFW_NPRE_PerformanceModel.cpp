...
void FIVE_NFW_NPRE_PerformanceModel::connectChannel(Channel* channel_)
{
  FIVE_NFW_NPRE_Channel* channel = static_cast<FIVE_NFW_NPRE_Channel*>(channel_);
...
uint64_t FIVE_NFW_NPRE_PerformanceModel::getCycleCount(void)
{
...
std::string FIVE_NFW_NPRE_PerformanceModel::getPipelineStream(void)
{
...
std::string FIVE_NFW_NPRE_PerformanceModel::getPrintHeader(void)
{
  std::stringstream ret_strs;
