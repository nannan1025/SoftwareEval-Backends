...
extern InstructionPrinterSet* FIVE_NFW_NPRE_InstrPrinterSet;

FIVE_NFW_NPRE_Printer::FIVE_NFW_NPRE_Printer(): Printer("FIVE_NFW_NPRE_Printer", FIVE_NFW_NPRE_InstrPrinterSet)
{}

void FIVE_NFW_NPRE_Printer::connectChannel(Channel* ch_)
{
  FIVE_NFW_NPRE_Channel* channel = static_cast<FIVE_NFW_NPRE_Channel*>(ch_);
...
std::string FIVE_NFW_NPRE_Printer::getPrintHeader(void)
{
