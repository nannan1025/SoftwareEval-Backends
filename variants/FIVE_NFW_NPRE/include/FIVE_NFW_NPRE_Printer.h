...
#ifndef SWEVAL_BACKENDS_FIVE_NFW_NPRE_PRINTER_H
#define SWEVAL_BACKENDS_FIVE_NFW_NPRE_PRINTER_H
...
class FIVE_NFW_NPRE_Printer : public Printer
{
public:

  FIVE_NFW_NPRE_Printer();
...
#endif // SWEVAL_BACKENDS_FIVE_NFW_NPRE_PRINTER_H