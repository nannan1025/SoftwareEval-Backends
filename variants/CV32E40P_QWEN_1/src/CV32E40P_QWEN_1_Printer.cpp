...
extern InstructionPrinterSet* CV32E40P_QWEN_1_InstrPrinterSet;

CV32E40P_QWEN_1_Printer::CV32E40P_QWEN_1_Printer(): Printer("CV32E40P_QWEN_1_Printer", CV32E40P_QWEN_1_InstrPrinterSet)
{}

void CV32E40P_QWEN_1_Printer::connectChannel(Channel* ch_)
{
  CV32E40P_QWEN_1_Channel* channel = static_cast<CV32E40P_QWEN_1_Channel*>(ch_);
...
std::string CV32E40P_QWEN_1_Printer::getPrintHeader(void)
{
