...
SchedulingFunctionSet* CV32E40P_QWEN_1_SchedulingFunctionSet = new SchedulingFunctionSet("CV32E40P_QWEN_1_SchedulingFunctionSet");

static SchedulingFunction *schedulingFunction_add = new SchedulingFunction(
  CV32E40P_QWEN_1_SchedulingFunctionSet,
  "add",
  0,
  [](PerformanceModel* perfModel_){
  CV32E40P_QWEN_1_PerformanceModel* perfModel = static_cast<CV32E40P_QWEN_1_PerformanceModel*>(perfModel_);
  // Enter
...
// ID
uint64_t n_ID;
n_ID = std::max({n_Decoder, n_uA_OF_A, n_uA_OF_B});
perfModel->ID = n_ID;
...
// ID
uint64_t n_ID;
n_ID = std::max({n_Decoder, n_uA_OF_A});
perfModel->ID = n_ID;
