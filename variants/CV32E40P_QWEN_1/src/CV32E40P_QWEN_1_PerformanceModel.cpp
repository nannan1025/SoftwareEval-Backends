...
void CV32E40P_QWEN_1_PerformanceModel::connectChannel(Channel* channel_)
{
  CV32E40P_QWEN_1_Channel* channel = static_cast<CV32E40P_QWEN_1_Channel*>(channel_);
...
uint64_t CV32E40P_QWEN_1_PerformanceModel::getCycleCount(void)
{
...
std::string CV32E40P_QWEN_1_PerformanceModel::getPipelineStream(void)
{
...
std::string CV32E40P_QWEN_1_PerformanceModel::getPrintHeader(void)
{
  std::stringstream ret_strs;
