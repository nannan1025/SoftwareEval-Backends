...
#ifndef SWEVAL_BACKENDS_CVA62_PERFORMANCE_MODEL_H
#define SWEVAL_BACKENDS_CVA62_PERFORMANCE_MODEL_H
...
extern SchedulingFunctionSet* CVA62_SchedulingFunctionSet;

class CVA62_PerformanceModel : public PerformanceModel
{
public:

  CVA62_PerformanceModel() : PerformanceModel("CVA62", CVA62_SchedulingFunctionSet)
    ,IF_stage(3,0)
    ,IQ_stage(7,0)
    ,EX_stage(8,0)
    ,COM_stage(2,0)
...
#endif // SWEVAL_BACKENDS_CVA62_PERFORMANCE_MODEL_H