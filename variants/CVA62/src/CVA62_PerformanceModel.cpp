...
void CVA62_PerformanceModel::connectChannel(Channel* channel_)
{
  CVA62_Channel* channel = static_cast<CVA62_Channel*>(channel_);
...
uint64_t CVA62_PerformanceModel::getCycleCount(void)
{
...
std::string CVA62_PerformanceModel::getPipelineStream(void)
{
...
std::string CVA62_PerformanceModel::getPrintHeader(void)
{
  std::stringstream ret_strs;
