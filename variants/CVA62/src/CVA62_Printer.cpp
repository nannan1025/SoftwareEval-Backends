...
extern InstructionPrinterSet* CVA62_InstrPrinterSet;

CVA62_Printer::CVA62_Printer(): Printer("CVA62_Printer", CVA62_InstrPrinterSet)
{}

void CVA62_Printer::connectChannel(Channel* ch_)
{
  CVA62_Channel* channel = static_cast<CVA62_Channel*>(ch_);
...
std::string CVA62_Printer::getPrintHeader(void)
{
