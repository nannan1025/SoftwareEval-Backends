...
InstructionPrinterSet *CV32E40P_LLM_InstrPrinterSet = new InstructionPrinterSet("CV32E40P_LLM_InstrPrinterSet");

static InstructionPrinter *instrPrinter_add = new InstructionPrinter(
  CV32E40P_LLM_InstrPrinterSet,
  "add",
  0,
  [](Printer* printer_){
    std::stringstream ret_strs;
    CV32E40P_LLM_Printer* printer = static_cast<CV32E40P_LLM_Printer*>(printer_);
