...
extern InstructionPrinterSet* CV32E40P_LLM_InstrPrinterSet;

CV32E40P_LLM_Printer::CV32E40P_LLM_Printer(): Printer("CV32E40P_LLM_Printer", CV32E40P_LLM_InstrPrinterSet)
{}

void CV32E40P_LLM_Printer::connectChannel(Channel* ch_)
{
  CV32E40P_LLM_Channel* channel = static_cast<CV32E40P_LLM_Channel*>(ch_);
...
std::string CV32E40P_LLM_Printer::getPrintHeader(void)
{
