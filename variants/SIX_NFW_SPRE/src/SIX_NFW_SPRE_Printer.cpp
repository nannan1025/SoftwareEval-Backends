...
extern InstructionPrinterSet* SIX_NFW_SPRE_InstrPrinterSet;

SIX_NFW_SPRE_Printer::SIX_NFW_SPRE_Printer(): Printer("SIX_NFW_SPRE_Printer", SIX_NFW_SPRE_InstrPrinterSet)
{}

void SIX_NFW_SPRE_Printer::connectChannel(Channel* ch_)
{
  SIX_NFW_SPRE_Channel* channel = static_cast<SIX_NFW_SPRE_Channel*>(ch_);
...
std::string SIX_NFW_SPRE_Printer::getPrintHeader(void)
{
