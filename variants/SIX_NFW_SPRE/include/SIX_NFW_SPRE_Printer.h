...
#ifndef SWEVAL_BACKENDS_SIX_NFW_SPRE_PRINTER_H
#define SWEVAL_BACKENDS_SIX_NFW_SPRE_PRINTER_H
...
class SIX_NFW_SPRE_Printer : public Printer
{
public:

  SIX_NFW_SPRE_Printer();
...
#endif // SWEVAL_BACKENDS_SIX_NFW_SPRE_PRINTER_H