...
#ifndef SWEVAL_BACKENDS_SIX_NFW_SPRE_PERFORMANCE_MODEL_H
#define SWEVAL_BACKENDS_SIX_NFW_SPRE_PERFORMANCE_MODEL_H
...
extern SchedulingFunctionSet* SIX_NFW_SPRE_SchedulingFunctionSet;

class SIX_NFW_SPRE_PerformanceModel : public PerformanceModel
{
public:

  SIX_NFW_SPRE_PerformanceModel() : PerformanceModel("SIX_NFW_SPRE", SIX_NFW_SPRE_SchedulingFunctionSet)
...
#endif // SWEVAL_BACKENDS_SIX_NFW_SPRE_PERFORMANCE_MODEL_H