...
#ifndef SWEVAL_BACKENDS_FIVE_FW_DYPRE_PRINTER_H
#define SWEVAL_BACKENDS_FIVE_FW_DYPRE_PRINTER_H
...
class FIVE_FW_DYPRE_Printer : public Printer
{
public:

  FIVE_FW_DYPRE_Printer();
...
#endif // SWEVAL_BACKENDS_FIVE_FW_DYPRE_PRINTER_H