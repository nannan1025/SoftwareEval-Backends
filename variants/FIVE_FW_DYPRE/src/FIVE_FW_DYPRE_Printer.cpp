...
extern InstructionPrinterSet* FIVE_FW_DYPRE_InstrPrinterSet;

FIVE_FW_DYPRE_Printer::FIVE_FW_DYPRE_Printer(): Printer("FIVE_FW_DYPRE_Printer", FIVE_FW_DYPRE_InstrPrinterSet)
{}

void FIVE_FW_DYPRE_Printer::connectChannel(Channel* ch_)
{
  FIVE_FW_DYPRE_Channel* channel = static_cast<FIVE_FW_DYPRE_Channel*>(ch_);
...
std::string FIVE_FW_DYPRE_Printer::getPrintHeader(void)
{
