...
InstructionPrinterSet *SHAKTI_C_InstrPrinterSet = new InstructionPrinterSet("SHAKTI_C_InstrPrinterSet");

static InstructionPrinter *instrPrinter_add = new InstructionPrinter(
  SHAKTI_C_InstrPrinterSet,
  "add",
  0,
  [](Printer* printer_){
    std::stringstream ret_strs;
    SHAKTI_C_Printer* printer = static_cast<SHAKTI_C_Printer*>(printer_);
