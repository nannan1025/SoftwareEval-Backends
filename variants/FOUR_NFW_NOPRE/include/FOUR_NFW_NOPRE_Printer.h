...
#ifndef SWEVAL_BACKENDS_FOUR_NFW_NOPRE_PRINTER_H
#define SWEVAL_BACKENDS_FOUR_NFW_NOPRE_PRINTER_H
...
class FOUR_NFW_NOPRE_Printer : public Printer
{
public:

  FOUR_NFW_NOPRE_Printer();
...
#endif // SWEVAL_BACKENDS_FOUR_NFW_NOPRE_PRINTER_H