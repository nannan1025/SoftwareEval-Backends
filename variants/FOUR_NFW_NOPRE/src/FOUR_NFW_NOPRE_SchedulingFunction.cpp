...
SchedulingFunctionSet* FOUR_NFW_NOPRE_SchedulingFunctionSet = new SchedulingFunctionSet("FOUR_NFW_NOPRE_SchedulingFunctionSet");

static SchedulingFunction *schedulingFunction_add = new SchedulingFunction(
  FOUR_NFW_NOPRE_SchedulingFunctionSet,
  "add",
  0,
  [](PerformanceModel* perfModel_){
  FOUR_NFW_NOPRE_PerformanceModel* perfModel = static_cast<FOUR_NFW_NOPRE_PerformanceModel*>(perfModel_);
  // Enter
