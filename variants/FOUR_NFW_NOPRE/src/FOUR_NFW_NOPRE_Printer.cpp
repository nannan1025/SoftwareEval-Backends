...
extern InstructionPrinterSet* FOUR_NFW_NOPRE_InstrPrinterSet;

FOUR_NFW_NOPRE_Printer::FOUR_NFW_NOPRE_Printer(): Printer("FOUR_NFW_NOPRE_Printer", FOUR_NFW_NOPRE_InstrPrinterSet)
{}

void FOUR_NFW_NOPRE_Printer::connectChannel(Channel* ch_)
{
  FOUR_NFW_NOPRE_Channel* channel = static_cast<FOUR_NFW_NOPRE_Channel*>(ch_);
...
std::string FOUR_NFW_NOPRE_Printer::getPrintHeader(void)
{
