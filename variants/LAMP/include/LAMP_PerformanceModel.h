...
#ifndef SWEVAL_BACKENDS_LAMP_PERFORMANCE_MODEL_H
#define SWEVAL_BACKENDS_LAMP_PERFORMANCE_MODEL_H
...
extern SchedulingFunctionSet* LAMP_SchedulingFunctionSet;

class LAMP_PerformanceModel : public PerformanceModel
{
public:

  LAMP_PerformanceModel() : PerformanceModel("LAMP", LAMP_SchedulingFunctionSet)
...
#endif // SWEVAL_BACKENDS_LAMP_PERFORMANCE_MODEL_H