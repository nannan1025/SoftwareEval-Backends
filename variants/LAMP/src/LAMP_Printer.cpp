...
extern InstructionPrinterSet* LAMP_InstrPrinterSet;

LAMP_Printer::LAMP_Printer(): Printer("LAMP_Printer", LAMP_InstrPrinterSet)
{}

void LAMP_Printer::connectChannel(Channel* ch_)
{
  LAMP_Channel* channel = static_cast<LAMP_Channel*>(ch_);
...
std::string LAMP_Printer::getPrintHeader(void)
{
